    ...
    <div className="home">
      <div className="home_container">
        ...
        <div className="home__row">
          ...
          <Product  id="2" title="USB C Cable, JSAUX (2m 2-Pack) Type C Fast Charger Charging Cable Braided Compatible for Samsung Galaxy S10 S9 S8 S20 Plus A3 A5 2017 Note 10 9 8, Huawei P10 P9, Google Pixel, Sony Xperia XZ, LG -Red" image="https://images-na.ssl-images-amazon.com/images/I/61kEKkw2D%2BL._SX425_.jpg" price={6.99} rating={5} />
        </div>
